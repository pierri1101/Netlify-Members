...
<div>
    <b-row>
        <b-colxx xxs="12">
            <piaf-breadcrumb :heading="$t('Nome da Assinatura')" />
    ...
    <b-row>
        <b-colxx xxs="12" md="12" xl="8" class="col-left">
            <b-card class="mb-4" no-body>
                <b-card-body>
                    <div class="mb-5">
                        <h5 class="card-title">Comece por aqui</h5>
                        <p>
        ...
        <b-colxx xxs="12" md="12" xl="4" class="col-left">
            <b-card class="mb-4" no-body>
                <b-card-body class="p-0">
                        ...
                        :sources="[{ src: 'http://dominvestimentos.com.br/wp-content/uploads/2020/10/background-dom.mp4', type: 'video/mp4'}]" />
                </b-card-body>
                <b-card-body>
                    <p class="list-item-heading mb-4">Assista esse vídeo</p>
                    <footer>
