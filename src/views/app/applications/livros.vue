...
<div>
    <b-row>
        <b-colxx xxs="12">
            <piaf-breadcrumb :heading="$t('Livros Sugeridos')" />
            <div class="separator mb-4"></div>
            <b-colxx xxs="12" class="mb-5">
            </b-colxx>
        </b-colxx>
        <b-colxx v-for="(blogItem,blogIndex) in livros" xxs="12" lg="6" class="mb-4" :key="`blogItem_${blogIndex}`">
